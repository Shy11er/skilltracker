    ...
    import net.brekker.auth.dto.ExceptionResponseDto;
    import net.brekker.auth.dto.ValidationErrorResponseDto;
    import net.brekker.auth.dto.Violation;
    import net.brekker.common.exceptions.ProviderConflictException;
